...
const NoDataFound = () => {
  return (
    <div className=" min-h-[80vh] flex flex-col items-center justify-center p-10 mt-10 rounded-2xl border border-dashed border-gray-600/30 bg-base-200/50 backdrop-blur-md">
      <div className="relative mb-6">
        ...
        <div className="relative z-10 p-5 rounded-full bg-linear-to-tr from-base-300 to-base-100 border border-gray-600/50 shadow-xl">
          <SiTimescale className="text-9xl"/>
        </div>
      </div>
