...
function Footer() {
    return (
        <footer className="w-full flex flex-col items-center py-16 px-6 md:px-12 bg-[#285341]" >
            <div className="container mx-auto">
                <div className="flex flex-col items-center text-center  mb-16">
                    ...
                    <div className="flex gap-3">
                        <a href="#" className="flex items-center justify-center w-10 h-10 bg-white rounded-full text-[#285341] hover:bg-gray-200 transition-colors">
                            <FaInstagram size={18} />
                        </a>
                        <a href="#" className="flex items-center justify-center w-10 h-10 bg-white rounded-full text-[#285341] hover:bg-gray-200 transition-colors">
                            <FaFacebookF size={18} />
